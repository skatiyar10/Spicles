...
public class WishlistActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayList<String> name =imageUrlUtils.getName();
        ArrayList<String> desc =imageUrlUtils.getDesc();
        ArrayList<String> price =imageUrlUtils.getPrice();
        RecyclerView recyclerView = (RecyclerView)findViewById(R.id.recyclerview);
        RecyclerView.LayoutManager recylerViewLayoutManager = new LinearLayoutManager(mContext);

        recyclerView.setLayoutManager(recylerViewLayoutManager);
        recyclerView.setAdapter(new SimpleStringRecyclerViewAdapter(recyclerView, wishlistImageUri,name,desc,price));
    }
...
//                ((BitmapDrawable) holder.mImageView.getTopLevelDrawable()).getBitmap().recycle();
        ...
        public void onBindViewHolder(final WishlistActivity.SimpleStringRecyclerViewAdapter.ViewHolder holder, final int position) {
            ...
            holder.mItemName.setText(mName.get(position));
            holder.mItemDes.setText(mDesc.get(position));
            holder.mItemPrice.setText(mPrice.get(position));
