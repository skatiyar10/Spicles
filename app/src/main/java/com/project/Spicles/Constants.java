...
public class Constants {
    public static final String M_ID = "RzUkyv05044399918557"; //Paytm Merchand Id we got it in paytm credentials
    ...
    public static final String CALLBACK_URL = "http://192.168.241.2/paytm/verifyChecksum.php";
